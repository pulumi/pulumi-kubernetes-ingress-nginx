...
type IngressControllerArgsType struct {
...
// IngressControllerArgsTypeInput is an input type that accepts IngressControllerArgsTypeArgs and IngressControllerArgsTypeOutput values.
// You can construct a concrete instance of `IngressControllerArgsTypeInput` via:
//
//          IngressControllerArgsTypeArgs{...}
type IngressControllerArgsTypeInput interface {
	pulumi.Input

	ToIngressControllerArgsTypeOutput() IngressControllerArgsTypeOutput
	ToIngressControllerArgsTypeOutputWithContext(context.Context) IngressControllerArgsTypeOutput
}

type IngressControllerArgsTypeArgs struct {
	Controller ControllerPtrInput `pulumi:"controller"`
	// Default 404 backend.
	DefaultBackend ControllerDefaultBackendPtrInput `pulumi:"defaultBackend"`
	// A base64ed Diffie-Hellman parameter. This can be generated with: openssl dhparam 4096 2> /dev/null | base64 Ref: https://github.com/kubernetes/ingress-nginx/tree/main/docs/examples/customization/ssl-dh-param.
	DhParam pulumi.StringPtrInput `pulumi:"dhParam"`
	// Overrides for generated resource names.
	FullnameOverride pulumi.StringPtrInput `pulumi:"fullnameOverride"`
	// HelmOptions is an escape hatch that lets the end user control any aspect of the Helm deployment. This exposes the entirety of the underlying Helm Release component args.
	HelmOptions ReleasePtrInput `pulumi:"helmOptions"`
	// Optional array of imagePullSecrets containing private registry credentials Ref: https://kubernetes.io/docs/tasks/configure-pod-container/pull-image-private-registry/.
	...
	// If true, create & use Pod Security Policy resources https://kubernetes.io/docs/concepts/policy/pod-security-policy/
	PodSecurityPolicy ControllerPodSecurityPolicyPtrInput `pulumi:"podSecurityPolicy"`
	// Enable RBAC as per https://github.com/kubernetes/ingress-nginx/blob/main/docs/deploy/rbac.md and https://github.com/kubernetes/ingress-nginx/issues/266
	Rbac ControllerRBACPtrInput `pulumi:"rbac"`
	// Rollback limit.
...
func (IngressControllerArgsTypeArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*IngressControllerArgsType)(nil)).Elem()
}

func (i IngressControllerArgsTypeArgs) ToIngressControllerArgsTypeOutput() IngressControllerArgsTypeOutput {
	return i.ToIngressControllerArgsTypeOutputWithContext(context.Background())
}

func (i IngressControllerArgsTypeArgs) ToIngressControllerArgsTypeOutputWithContext(ctx context.Context) IngressControllerArgsTypeOutput {
	return pulumi.ToOutputWithContext(ctx, i).(IngressControllerArgsTypeOutput)
}

type IngressControllerArgsTypeOutput struct{ *pulumi.OutputState }

func (IngressControllerArgsTypeOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*IngressControllerArgsType)(nil)).Elem()
}

func (o IngressControllerArgsTypeOutput) ToIngressControllerArgsTypeOutput() IngressControllerArgsTypeOutput {
	return o
}

func (o IngressControllerArgsTypeOutput) ToIngressControllerArgsTypeOutputWithContext(ctx context.Context) IngressControllerArgsTypeOutput {
	return o
}

func (o IngressControllerArgsTypeOutput) Controller() ControllerPtrOutput {
	return o.ApplyT(func(v IngressControllerArgsType) *Controller { return v.Controller }).(ControllerPtrOutput)
}

// Default 404 backend.
func (o IngressControllerArgsTypeOutput) DefaultBackend() ControllerDefaultBackendPtrOutput {
	return o.ApplyT(func(v IngressControllerArgsType) *ControllerDefaultBackend { return v.DefaultBackend }).(ControllerDefaultBackendPtrOutput)
}

// A base64ed Diffie-Hellman parameter. This can be generated with: openssl dhparam 4096 2> /dev/null | base64 Ref: https://github.com/kubernetes/ingress-nginx/tree/main/docs/examples/customization/ssl-dh-param.
func (o IngressControllerArgsTypeOutput) DhParam() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IngressControllerArgsType) *string { return v.DhParam }).(pulumi.StringPtrOutput)
}

// Overrides for generated resource names.
func (o IngressControllerArgsTypeOutput) FullnameOverride() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IngressControllerArgsType) *string { return v.FullnameOverride }).(pulumi.StringPtrOutput)
}

// HelmOptions is an escape hatch that lets the end user control any aspect of the Helm deployment. This exposes the entirety of the underlying Helm Release component args.
func (o IngressControllerArgsTypeOutput) HelmOptions() ReleasePtrOutput {
	return o.ApplyT(func(v IngressControllerArgsType) *Release { return v.HelmOptions }).(ReleasePtrOutput)
}

// Optional array of imagePullSecrets containing private registry credentials Ref: https://kubernetes.io/docs/tasks/configure-pod-container/pull-image-private-registry/.
func (o IngressControllerArgsTypeOutput) ImagePullSecrets() corev1.LocalObjectReferenceArrayOutput {
	return o.ApplyT(func(v IngressControllerArgsType) []corev1.LocalObjectReference { return v.ImagePullSecrets }).(corev1.LocalObjectReferenceArrayOutput)
}

// Overrides for generated resource names.
func (o IngressControllerArgsTypeOutput) NameOverride() pulumi.StringPtrOutput {
	return o.ApplyT(func(v IngressControllerArgsType) *string { return v.NameOverride }).(pulumi.StringPtrOutput)
}

// If true, create & use Pod Security Policy resources https://kubernetes.io/docs/concepts/policy/pod-security-policy/
func (o IngressControllerArgsTypeOutput) PodSecurityPolicy() ControllerPodSecurityPolicyPtrOutput {
	return o.ApplyT(func(v IngressControllerArgsType) *ControllerPodSecurityPolicy { return v.PodSecurityPolicy }).(ControllerPodSecurityPolicyPtrOutput)
}

// Enable RBAC as per https://github.com/kubernetes/ingress-nginx/blob/main/docs/deploy/rbac.md and https://github.com/kubernetes/ingress-nginx/issues/266
func (o IngressControllerArgsTypeOutput) Rbac() ControllerRBACPtrOutput {
	return o.ApplyT(func(v IngressControllerArgsType) *ControllerRBAC { return v.Rbac }).(ControllerRBACPtrOutput)
}

// Rollback limit.
func (o IngressControllerArgsTypeOutput) RevisionHistoryLimit() pulumi.IntPtrOutput {
	return o.ApplyT(func(v IngressControllerArgsType) *int { return v.RevisionHistoryLimit }).(pulumi.IntPtrOutput)
}

func (o IngressControllerArgsTypeOutput) ServiceAccount() ControllerServiceAccountPtrOutput {
	return o.ApplyT(func(v IngressControllerArgsType) *ControllerServiceAccount { return v.ServiceAccount }).(ControllerServiceAccountPtrOutput)
}

// TCP service key:value pairs Ref: https://github.com/kubernetes/ingress-nginx/blob/main/docs/user-guide/exposing-tcp-udp-services.md.
func (o IngressControllerArgsTypeOutput) Tcp() pulumi.StringMapMapOutput {
	return o.ApplyT(func(v IngressControllerArgsType) map[string]map[string]string { return v.Tcp }).(pulumi.StringMapMapOutput)
}

// UDP service key:value pairs Ref: https://github.com/kubernetes/ingress-nginx/blob/main/docs/user-guide/exposing-tcp-udp-services.md.
func (o IngressControllerArgsTypeOutput) Udp() pulumi.StringMapMapOutput {
	return o.ApplyT(func(v IngressControllerArgsType) map[string]map[string]string { return v.Udp }).(pulumi.StringMapMapOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(IngressControllerArgsTypeOutput{})
