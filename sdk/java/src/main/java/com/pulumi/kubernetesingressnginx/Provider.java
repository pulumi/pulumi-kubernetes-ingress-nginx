...
import com.pulumi.kubernetesingressnginx.ProviderArgs;
import com.pulumi.kubernetesingressnginx.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:kubernetes-ingress-nginx")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes-ingress-nginx", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
