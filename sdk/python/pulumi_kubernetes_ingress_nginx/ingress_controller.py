...
class IngressControllerArgs:
    def __init__(__self__, *,
                 controller: pulumi.Input[Optional['ControllerArgs']] = None,
                 default_backend: pulumi.Input[Optional['ControllerDefaultBackendArgs']] = None,
                 dh_param: pulumi.Input[Optional[_builtins.str]] = None,
                 fullname_override: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 pod_security_policy: pulumi.Input[Optional['ControllerPodSecurityPolicyArgs']] = None,
                 rbac: pulumi.Input[Optional['ControllerRBACArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] dh_param: A base64ed Diffie-Hellman parameter. This can be generated with: openssl dhparam 4096 2> /dev/null | base64 Ref: https://github.com/kubernetes/ingress-nginx/tree/main/docs/examples/customization/ssl-dh-param.
        :param pulumi.Input[_builtins.str] fullname_override: Overrides for generated resource names.
        ...
        :param pulumi.Input[_builtins.str] name_override: Overrides for generated resource names.
        ...
        :param pulumi.Input[_builtins.int] revision_history_limit: Rollback limit.
        :param pulumi.Input[Mapping[str, pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]] tcp: TCP service key:value pairs Ref: https://github.com/kubernetes/ingress-nginx/blob/main/docs/user-guide/exposing-tcp-udp-services.md.
        :param pulumi.Input[Mapping[str, pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]] udp: UDP service key:value pairs Ref: https://github.com/kubernetes/ingress-nginx/blob/main/docs/user-guide/exposing-tcp-udp-services.md.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def controller(self) -> pulumi.Input[Optional['ControllerArgs']]:
        return pulumi.get(self, "controller")

    @controller.setter
    def controller(self, value: pulumi.Input[Optional['ControllerArgs']]):
        pulumi.set(self, "controller", value)

    @_builtins.property
    @pulumi.getter(name="defaultBackend")
    def default_backend(self) -> pulumi.Input[Optional['ControllerDefaultBackendArgs']]:
        """
        Default 404 backend.
        """
    ...
    def default_backend(self, value: pulumi.Input[Optional['ControllerDefaultBackendArgs']]):
        pulumi.set(self, "default_backend", value)

    @_builtins.property
    @pulumi.getter(name="dhParam")
    def dh_param(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @dh_param.setter
    def dh_param(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "dh_param", value)

    @_builtins.property
    @pulumi.getter(name="fullnameOverride")
    def fullname_override(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def fullname_override(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def pod_security_policy(self) -> pulumi.Input[Optional['ControllerPodSecurityPolicyArgs']]:
        """
    ...
    def pod_security_policy(self, value: pulumi.Input[Optional['ControllerPodSecurityPolicyArgs']]):
        pulumi.set(self, "pod_security_policy", value)

    @_builtins.property
    @pulumi.getter
    def rbac(self) -> pulumi.Input[Optional['ControllerRBACArgs']]:
        """
    ...
    @rbac.setter
    def rbac(self, value: pulumi.Input[Optional['ControllerRBACArgs']]):
...
class IngressController(pulumi.ComponentResource):
    ...
    def __init__(__self__,
                 ...
                 controller: pulumi.Input[Optional[Union['ControllerArgs', 'ControllerArgsDict']]] = None,
                 default_backend: pulumi.Input[Optional[Union['ControllerDefaultBackendArgs', 'ControllerDefaultBackendArgsDict']]] = None,
                 dh_param: pulumi.Input[Optional[_builtins.str]] = None,
                 fullname_override: pulumi.Input[Optional[_builtins.str]] = None,
                 helm_options: Optional[Union['ReleaseArgs', 'ReleaseArgsDict']] = None,
                 image_pull_secrets: pulumi.Input[Optional[Sequence[pulumi.Input[pulumi.InputType['pulumi_kubernetes.core.v1.LocalObjectReferenceArgs']]]]] = None,
                 name_override: pulumi.Input[Optional[_builtins.str]] = None,
                 pod_security_policy: pulumi.Input[Optional[Union['ControllerPodSecurityPolicyArgs', 'ControllerPodSecurityPolicyArgsDict']]] = None,
                 rbac: pulumi.Input[Optional[Union['ControllerRBACArgs', 'ControllerRBACArgsDict']]] = None,
                 revision_history_limit: pulumi.Input[Optional[_builtins.int]] = None,
                 service_account: pulumi.Input[Optional[Union['ControllerServiceAccountArgs', 'ControllerServiceAccountArgsDict']]] = None,
                 tcp: pulumi.Input[Optional[Mapping[str, pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]]] = None,
                 udp: pulumi.Input[Optional[Mapping[str, pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]]] = None,
                 __props__=None):
        """
